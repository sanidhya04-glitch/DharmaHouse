      ...
      <main className="flex-1">
        ...
        <section id="home" className="relative h-screen w-full flex items-center justify-center text-center text-white">
          ...
          <div className="container max-w-7xl animate-fade-in-up pt-16">
            <h1 className="font-headline text-5xl md:text-8xl font-bold drop-shadow-lg">United in Spirit, Driven to Win.</h1>
            ...
            <Button asChild size="lg" className="mt-8 bg-primary text-primary-foreground hover:bg-primary/90 transition-transform duration-300 ease-in-out hover:scale-105">
