        ...
        <section id="achievements" className="relative py-20 md:py-32 bg-background">
          <div className="container max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-headline text-4xl md:text-5xl font-bold text-primary">Our Achievements</h2>
            ...
            <Carousel opts={{ align: "start", loop: true, }} className="w-full">
              ...
              <CarouselPrevious className="hidden sm:flex bg-card/50 hover:bg-card border-primary text-primary hover:text-primary" />
              <CarouselNext className="hidden sm:flex bg-card/50 hover:bg-card border-primary text-primary hover:text-primary" />
            </Carousel>
          </div>
        </section>
    );
