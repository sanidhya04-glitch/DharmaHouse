...
export function Motto() {
  return (
    <section id="motto" className="relative py-20 md:py-32 bg-background">
      <div className="container max-w-5xl mx-auto">
        <div className="text-center">
            <DharmaHouseLogo className="h-16 w-16 text-primary mx-auto" />
            <h2 className="mt-6 font-headline text-4xl md:text-6xl text-gradient">"Strength. Discipline. Victory."</h2>
